...
class QuotesSpider(CrawlSpider):
    ...
    def parse_start_url(self, response):
        ...
        #request(url=link,callback=self.parse_details,headers={"User-Agent":"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.78 Safari/537.36","Referer":"https://findadentist.ada.org/search-results?address=11718"})
    ...
    def parse_details(self, response):
        for row in response.xpath('//div[@class="name-details"]'):
            ...
            re.findall('var FirstName.+?(d+)',response.body)[0]
